...
public class OrderManager {
	...
	public boolean isOnTimePickup(Order o) {
		return !o.getProductionDateTime().isBefore(LocalDateTime.now());
	}

	public boolean isOnTimeDelivery(Order o) {
		return !o.getDeliveryDateTime().isBefore(LocalDateTime.now());
	}
